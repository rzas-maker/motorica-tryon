        ...
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "32px 20px 60px" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(180px,1fr))", gap: 12 }}>
              {[
                { level: "МАНИФЕСТО Фингерс (MANIFESTO Fingers)", type: "Бионический", icon: "💪", bg: "#EFF6FF", border: "#93C5FD", text: "#1e40af", desc: "Бионический многосхватный протез пальцев и кисти управляется с помощью датчиков, считывающих активности мышц" },
                { level: "КИБИ Фингерс (CYBI Fingers)", type: "Тяговый", icon: "🤖", bg: "#EFF6FF", border: "#93C5FD", text: "#1e40af", desc: "Лёгкий тяговый протез кисти и пальцев с подвижным лучезапястным суставом" },
                { level: "КИБИ Хэнд (CYBI Hand)", type: "Тяговый", icon: "✊", bg: "#ECFDF5", border: "#6EE7B7", text: "#065f46", desc: "Лёгкий функциональный тяговый протез предплечья" },
                { level: "ИНДИ Хэнд (INDY Hand)", type: "Бионический", icon: "🤖", bg: "#EFF6FF", border: "#93C5FD", text: "#1e40af", desc: "Стильный функциональный бионический протез предплечья с односхватом" },
                { level: "МАНИФЕСТО Хэнд (MANIFESTO Hand)", type: "Бионический", icon: "🤌", bg: "#ECFDF5", border: "#6EE7B7", text: "#065f46", desc: "Управляется с помощью датчиков, считывающих активности мышц. Пальцы могут двигаться независимо друг от друга" },
                { level: "МАНИФЕСТО/ИНДИ Элбоу (MANIFESTO/INDY Elbow)", type: "Бионический", icon: "🤌", bg: "#ECFDF5", border: "#6EE7B7", text: "#065f46", desc: "ELBOW относится к роботизированной линейке протезов на уровне выше локтя. Конфигурация протеза может состоять из кисти MANIFESTO или INDY" },
              ].map((s, i) => (
